...
const STORAGE_KEY = 'msft-seacole-safety-report-draft-v2';
...
function App() {
  ...
  function downloadJson() {
    const payload = {
      ...
      reportName: 'Seacole Safety Report',
    ...
    <main>
      <header className="hero">
        <div>
          ...
          <h1>Seacole Safety Report</h1>
          <p className="hero-copy">Internal incident, concern and learning report form</p>
        </div>
      ...
      <div className="notice">
        ...
        <p>
          ...
          Escalate urgent safety concerns immediately through local clinical routes; this form does not replace emergency escalation.
        </p>
      </div>
          ...
          <div className="form-stack">
            <Section icon="👤" title="Reporter details" subtitle="Details of the person completing the report.">
              <div className="grid two">
                ...
                <Field label="Role / job title" required><TextInput value={form.reporterRole} onChange={(v) => set('reporterRole', v)} /></Field>
